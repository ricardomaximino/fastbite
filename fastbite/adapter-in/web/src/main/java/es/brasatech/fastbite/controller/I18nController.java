...
public class I18nController {
    ...
    public String saveGroupTranslations(
        ...
        I18nField updatedDescription = parseFieldTranslations(existingGroup.description(), formData, "description");
    ...
    public String saveProductTranslations(
        ...
        I18nField updatedDescription = parseFieldTranslations(existingProduct.description(), formData, "description");
    ...
    public String saveCustomizationTranslations(
        ...
        var updatedOptions = existingCustomization.options().stream()
                .map(opt -> {
                    I18nField updatedOptionName = parseFieldTranslations(opt.name(), formData, "option_" + opt.id());
